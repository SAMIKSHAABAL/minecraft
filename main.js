...
if(keyPressed == '76') { new_image(light_green.png); console.log("light_green"); }
if(keyPressed == '84') { new_image(trunk.jpg); console.log("trunk"); }
if(keyPressed == '82') { new_image(roof.jpg); console.log("roof"); }
if(keyPressed == '89') { new_image(yellow_wall.png); console.log("yellow"); }
if(keyPressed == '68') { new_image(dark_green.png); console.log("dark_green"); }
